...
import 'package:jb/config/palette.dart';
import 'package:jb/constants/color.dart';
import 'package:jb/screens/completeprofilepage/registration/registration1.dart';
...
class _LoginSignupScreenState extends State<LoginSignupScreen> {
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage("image/wedding1.jpg"),
                      fit: BoxFit.fill)),
              child: Container(
                  ...
                  children: [
                    RichText(
                      text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                              text: isSignupScreen ? " JainBandhan, " : " Back,",
                              style: TextStyle(
                                fontSize: 25,
  ...
  Container buildSigninSection() {
    return Container(
      ...
      child: Column(
        children: [
          buildTextField(Icons.person, "Username", false, true),
          buildTextField(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          buildTextField(
              MaterialCommunityIcons.email_outline, "phone no.", false, true),
          buildTextField(
